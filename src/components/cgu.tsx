...
export const CGU = (props: any) => {
    return (
        <div>
            ...
            L’Utilisateur reconnaît avoir vérifié que la configuration informatique qu’il utilise est sécurisée et en état de fonctionnement.
            ...
            L’Utilisateur reconnaît que l’Exploitant ne contrôle ni ne contribue en aucune manière à l’élaboration des conditions d’utilisation et/ou du contenu s’appliquant à ou figurant sur ces sites tiers.
            ...
            En outre, l’Utilisateur reconnaît que l’Exploitant ne saurait cautionner, garantir ou reprendre à son compte tout ou partie des conditions d’utilisation et/ou du contenu de ces sites tiers.
            ...
            En cas d'échec de la demande de réclamation auprès du service client ou en l'absence de réponse de ce service dans un délai de 90 jours, le Client peut soumettre le différend relatif au bon de commande ou aux présentes CGV l'opposant à l’Exploitant au médiateur suivant : [identité et coordonnées du médiateur].
