...
export const PrivacyPolicyEN = (props: any) => {
	return (
		<div id="container">
			<h1>PRIVACY POLICY FOR MIKTO</h1>

			This privacy policy governs your use of the software application Mikto (“Mikto”) for mobile devices that was created by Blatom SAS. The Application is a dating app, that also features a store populated by business partners.
			...
			This Application does not collect precise information about the location of your mobile device.<br />
			...
			<h3>Your Consent</h3>
			By using the Application, you are consenting to our processing of your information as set forth in this Privacy Policy now and as amended by us. "Processing,” means using cookies on a computer/hand held device or using or touching information in any way, including, but not limited to, collecting, storing, deleting, using, combining and disclosing information, all of which activities will take place in France. If you reside outside of France your information will be transferred, processed and stored there under French privacy standards.



			<h3>Contact us</h3>
			If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact us via email at contact@blatom.fr.
		</div>
	)
}